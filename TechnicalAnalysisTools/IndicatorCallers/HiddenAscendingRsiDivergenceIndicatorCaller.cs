...
{
    public class HiddenAscendingRsiDivergenceIndicatorCaller : IndicatorCallerBase<HiddenAscendingDivergenceIndicator>
    {
        public HiddenAscendingRsiDivergenceIndicatorCaller(HiddenAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenAscendingRsiDivergence = (byte)divergence;
