...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class CrossDownAnotherFieldCondition : CandleOperationConditionBase
    {
        public CrossDownAnotherFieldCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field1, CandleDataModelFields field2, int candlesCount) : base(symbol, timeFrame, candleNumber)
        {
            Field1 = field1;
