...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class SmallerThanCondition : CandleOperationConditionBase
    {
        public SmallerThanCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field, float value) : base(symbol, timeFrame, candleNumber)
        {
            Field = field;
