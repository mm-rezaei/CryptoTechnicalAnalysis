...
{
    public class HiddenAscendingStochasticDValueDivergenceIndicatorCaller : IndicatorCallerBase<HiddenAscendingDivergenceIndicator>
    {
        public HiddenAscendingStochasticDValueDivergenceIndicatorCaller(HiddenAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenAscendingStochasticDValueDivergence = (byte)divergence;
