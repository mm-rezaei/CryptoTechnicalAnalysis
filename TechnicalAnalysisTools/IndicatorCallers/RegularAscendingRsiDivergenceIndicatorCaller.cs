...
{
    public class RegularAscendingRsiDivergenceIndicatorCaller : IndicatorCallerBase<RegularAscendingDivergenceIndicator>
    {
        public RegularAscendingRsiDivergenceIndicatorCaller(RegularAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularAscendingRsiDivergence = (byte)divergence;
