...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class GreaterThanCondition : CandleOperationConditionBase
    {
        public GreaterThanCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field, float value) : base(symbol, timeFrame, candleNumber)
        {
            Field = field;
