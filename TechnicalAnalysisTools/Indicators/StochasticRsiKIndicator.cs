...
namespace TechnicalAnalysisTools.Indicators
{
    public class StochasticRsiKIndicator : LengthIndicatorBase<decimal>
    {
        ...
        protected override IIndicatorValue OnProcess(IIndicatorValue input)
        {
            ...
            var highValue = _high.Process(input.SetValue(this, value)).GetValue<decimal>();
            var lowValue = _low.Process(input.SetValue(this, value)).GetValue<decimal>();
            ...
            return new DecimalIndicatorValue(this, 100 * (value - lowValue) / diff);
        }
