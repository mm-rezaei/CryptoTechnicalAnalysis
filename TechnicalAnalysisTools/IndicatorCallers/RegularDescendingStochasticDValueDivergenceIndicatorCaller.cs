...
{
    public class RegularDescendingStochasticDValueDivergenceIndicatorCaller : IndicatorCallerBase<RegularDescendingDivergenceIndicator>
    {
        public RegularDescendingStochasticDValueDivergenceIndicatorCaller(RegularDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularDescendingStochasticDValueDivergence = (byte)divergence;
