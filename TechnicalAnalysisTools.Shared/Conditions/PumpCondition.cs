...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class PumpCondition : CandleOperationConditionBase
    {
        public PumpCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field, float changed, int candlesCount) : base(symbol, timeFrame, candleNumber)
        {
            Field = field;
