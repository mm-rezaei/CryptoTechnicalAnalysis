...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class CrossUpCondition : CandleOperationConditionBase
    {
        public CrossUpCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field, float value, int candlesCount) : base(symbol, timeFrame, candleNumber)
        {
            Field = field;
