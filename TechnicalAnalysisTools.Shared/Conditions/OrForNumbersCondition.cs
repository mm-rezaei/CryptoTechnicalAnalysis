...
{
    public class OrForNumbersCondition : LogicalOperationForNumbersConditionBase
    {
        public OrForNumbersCondition(ICondition[] conditions, int lowerNumber, int upperNumber) : base(conditions, lowerNumber, upperNumber)
        {
