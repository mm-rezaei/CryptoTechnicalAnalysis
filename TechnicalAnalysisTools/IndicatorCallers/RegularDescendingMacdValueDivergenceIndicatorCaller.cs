...
{
    public class RegularDescendingMacdValueDivergenceIndicatorCaller : IndicatorCallerBase<RegularDescendingDivergenceIndicator>
    {
        public RegularDescendingMacdValueDivergenceIndicatorCaller(RegularDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularDescendingMacdValueDivergence = (byte)divergence;
