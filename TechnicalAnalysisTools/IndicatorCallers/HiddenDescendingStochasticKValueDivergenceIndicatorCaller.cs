...
{
    public class HiddenDescendingStochasticKValueDivergenceIndicatorCaller : IndicatorCallerBase<HiddenDescendingDivergenceIndicator>
    {
        public HiddenDescendingStochasticKValueDivergenceIndicatorCaller(HiddenDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenDescendingStochasticKValueDivergence = (byte)divergence;
