...
{
    public class RegularDescendingMacdSignalDivergenceIndicatorCaller : IndicatorCallerBase<RegularDescendingDivergenceIndicator>
    {
        public RegularDescendingMacdSignalDivergenceIndicatorCaller(RegularDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularDescendingMacdSignalDivergence = (byte)divergence;
