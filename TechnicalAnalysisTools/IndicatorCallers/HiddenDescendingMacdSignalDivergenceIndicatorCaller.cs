...
{
    public class HiddenDescendingMacdSignalDivergenceIndicatorCaller : IndicatorCallerBase<HiddenDescendingDivergenceIndicator>
    {
        public HiddenDescendingMacdSignalDivergenceIndicatorCaller(HiddenDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenDescendingMacdSignalDivergence = (byte)divergence;
