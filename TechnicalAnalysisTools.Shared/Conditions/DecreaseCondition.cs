...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class DecreaseCondition : CandleOperationConditionBase
    {
        public DecreaseCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field, int candlesCount) : base(symbol, timeFrame, candleNumber)
        {
            Field = field;
