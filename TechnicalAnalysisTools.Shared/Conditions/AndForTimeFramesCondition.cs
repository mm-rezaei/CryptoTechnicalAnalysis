...
{
    public class AndForTimeFramesCondition : LogicalOperationForTimeFramesConditionBase
    {
        public AndForTimeFramesCondition(ICondition[] conditions, TimeFrames lowerTimeFrame, TimeFrames upperTimeFrame) : base(conditions, lowerTimeFrame, upperTimeFrame)
        {
