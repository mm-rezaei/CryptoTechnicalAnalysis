...
{
    public class IchimokuSenkouB26LineIndicator : LengthIndicatorBase<decimal>
    {
        private List<Candle> _buffer = new List<Candle>();

        public IchimokuSenkouB26LineIndicator(IchimokuLineIndicator kijun)
        {
