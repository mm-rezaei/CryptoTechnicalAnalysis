...
namespace TechnicalAnalysisTools.Indicators
{
    public class RegularAscendingDivergenceIndicator : DivergenceIndicatorBase
    {
        ...
        protected override DivergenceTypes DivergenceType
        {
            get
            {
                return DivergenceTypes.RegularAscending;
            }
        }
    }
}
