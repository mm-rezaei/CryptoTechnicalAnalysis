...
{
    public class RegularAscendingMacdValueDivergenceIndicatorCaller : IndicatorCallerBase<RegularAscendingDivergenceIndicator>
    {
        public RegularAscendingMacdValueDivergenceIndicatorCaller(RegularAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularAscendingMacdValueDivergence = (byte)divergence;
