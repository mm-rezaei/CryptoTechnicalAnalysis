...
{
    public class HiddenDescendingStochasticDValueDivergenceIndicatorCaller : IndicatorCallerBase<HiddenDescendingDivergenceIndicator>
    {
        public HiddenDescendingStochasticDValueDivergenceIndicatorCaller(HiddenDescendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenDescendingStochasticDValueDivergence = (byte)divergence;
