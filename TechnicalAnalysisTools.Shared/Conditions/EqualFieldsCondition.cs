...
namespace TechnicalAnalysisTools.Shared.Conditions
{
    ...
    public class EqualFieldsCondition : CandleOperationConditionBase
    {
        public EqualFieldsCondition(SymbolTypes symbol, TimeFrames timeFrame, int candleNumber, CandleDataModelFields field1, CandleDataModelFields field2) : base(symbol, timeFrame, candleNumber)
        {
            Field1 = field1;
            Field2 = field2;
        }
