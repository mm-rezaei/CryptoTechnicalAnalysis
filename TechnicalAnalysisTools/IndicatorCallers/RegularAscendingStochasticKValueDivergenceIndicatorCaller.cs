...
{
    public class RegularAscendingStochasticKValueDivergenceIndicatorCaller : IndicatorCallerBase<RegularAscendingDivergenceIndicator>
    {
        public RegularAscendingStochasticKValueDivergenceIndicatorCaller(RegularAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.RegularAscendingStochasticKValueDivergence = (byte)divergence;
