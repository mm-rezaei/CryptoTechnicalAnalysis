...
namespace TechnicalAnalysisTools.Indicators
{
    public class RegularDescendingDivergenceIndicator : DivergenceIndicatorBase
    {
        ...
        protected override DivergenceTypes DivergenceType
        {
            get
            {
                return DivergenceTypes.RegularDescending;
            }
        }
    }
}
