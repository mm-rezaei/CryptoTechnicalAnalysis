...
{
    public class HiddenAscendingMacdHistogramDivergenceIndicatorCaller : IndicatorCallerBase<HiddenAscendingDivergenceIndicator>
    {
        public HiddenAscendingMacdHistogramDivergenceIndicatorCaller(HiddenAscendingDivergenceIndicator indicator) : base(indicator)
        {
        ...
        protected override bool OnProcess(Candle candle, CandleDataModel candleDataModel)
        {
            ...
            if (!indicatorValue.IsEmpty)
            {
                ...
                candleDataModel.HiddenAscendingMacdHistogramDivergence = (byte)divergence;
